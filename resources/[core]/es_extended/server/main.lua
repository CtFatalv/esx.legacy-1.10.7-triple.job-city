...
local loadPlayer = "SELECT `accounts`, `job`, `job_grade`, `job2`, `job2_grade`, `job3`, `job3_grade`, `group`, `position`, `inventory`, `skin`, `loadout`, `metadata`"
...
function loadESXPlayer(identifier, playerId, isNew)
    ...
    -- Job3
    local job3, grade3 = result.job3, tostring(result.job3_grade)

    if not ESX.DoesJob3Exist(job3, grade3) then
        print(("[^3WARNING^7] Ignoring invalid job3 for ^5%s^7 [job3: ^5%s^7, grade: ^5%s^7]"):format(identifier, job3, grade3))
        job3, grade3 = "unemployed3", "0"
    end
    ...
    userData.job3 = {
        id = job3Object.id,
        name = job3Object.name,
        label = job3Object.label,

        grade = tonumber(grade3),
        grade_name = grade3Object.name,
        grade_label = grade3Object.label,
        grade_salary = grade3Object.salary,

        skin_male = grade3Object.skin_male and json.decode(grade3Object.skin_male) or {},
        skin_female = grade3Object.skin_female and json.decode(grade3Object.skin_female) or {},
    }
    ...
    -- xPlayer Creation
    local xPlayer = CreateExtendedPlayer(playerId, identifier, userData.group, userData.accounts, userData.inventory, userData.weight, userData.job, userData.job2, userData.job3, userData.loadout, GetPlayerName(playerId), userData.coords, userData.metadata)
